...
3. 추가 운영자(중간 관리자)는 최고 운영자가 `/admin`의 "새 운영자 초대"에서 24시간 일회용 링크로 발급합니다. 운영자는 고객 승인·결제·차단을 처리할 수 있고, 새 운영자 초대와 운영자 해제는 최고 운영자만 할 수 있습니다. 해제된 운영자는 즉시 로그아웃되며 같은 이메일로 다시 초대할 수 있습니다.
