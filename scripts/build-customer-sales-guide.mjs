  ...
  <div class="layout" id="top">
    ...
    <main id="main">
      ...
      <section class="content" id="features">
        ...
        <article class="feature">
          <div class="feature-copy"><p class="feature-kicker">INTERPRETER ROOM</p><h3>각자 자기 화면에서 보는 통역 회의실</h3><p>링크와 비밀번호로 상대방을 초대하면 두 사람이 각자 자기 기기에서 같은 대화를 자기 언어로 봅니다. 내가 한 말이 상대에게 어떻게 전달됐는지 확인하고, 상대의 말은 내 언어로 읽습니다. 음성은 화상회의나 같은 방에서 그대로 주고받습니다.</p><ul><li>초대 링크와 비밀번호 한 번에 복사</li><li>문장이 끝나면 바로 양쪽 화면에 원문과 번역 표시</li><li>화상회의 모드와 같은 방 모드</li><li>회의 종료 뒤 24시간 동안 상대도 회의록을 원하는 언어로 내려받기</li></ul></div>
          <figure class="shot">
        ...
        <div class="matrix-wrap">
          <table>
            ...
            <tbody>
              ...
              <tr><td>통역 회의실</td><td>초대 링크·비밀번호, 참가자별 언어 화면, 실시간 번역, 회의록 다운로드</td><td>상대방과 각자 화면으로 같은 회의 진행</td><td>상대 링크는 회의 종료 뒤 24시간 유효</td></tr>
