...
function FallbackNavigation({
  ...
  return (
    <div className="flex h-full flex-col p-3">
      <GuardedLink href="/" data-i18n-user-attributes aria-label={BRAND_HOME_LABEL} className="px-3 py-3" onNavigationCommitted={onNavigationCommitted}><BrandWordmark compact /></GuardedLink>
      <SearchTrigger onOpenSearch={onOpenSearch} />
